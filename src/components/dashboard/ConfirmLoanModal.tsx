          ...
          <div className="bg-legasi-dark/30 border border-border/50 rounded-lg p-6 space-y-4">
            ...
            <div className="border-t border-border/30 pt-4 space-y-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <img
                    src={collateralType === "BTC" ? btcLogo : collateralType === "SOL" ? usdcLogo : usdcLogo}
                    alt={collateralType}
                    className="w-6 h-6"
                  />
                  <div>
              ...
              <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <img
                      src={borrowCurrency === "USDC" ? usdcLogo : eurcLogo}
                      alt={borrowCurrency}
                      className="w-6 h-6"
                    />
                    <p className="text-xl font-bold text-legasi-orange">
                      {borrowAmount.toLocaleString(undefined, { minimumFractionDigits: 0, maximumFractionDigits: 0 })}{" "}
                      {borrowCurrency}
                    </p>
                  </div>
                  {Math.abs(borrowAmount - maxBorrowable) < 1 && (
                    <span className="text-xs bg-orange-500/20 text-orange-400 px-2 py-1 rounded">Max Loan</span>
                  )}
                </div>
              </div>
              ...
              <div className="border-t border-border/30 pt-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className={`text-lg font-bold ${getHealthColor()}`}>{metrics.healthFactor.toFixed(2)}</p>
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold">${metrics.liquidationPrice.toLocaleString()}</p>
                    <p className="text-xs text-muted-foreground">{collateralType} price</p>
                  </div>
              ...
              {borrowAmount / maxBorrowable > 0.75 && (
                ...
                >
                  <p className={`text-xs ${borrowAmount / maxBorrowable > 0.9 ? "text-red-400" : "text-orange-400"}`}>
                    {borrowAmount / maxBorrowable > 0.9
          ...
          {loanData.autoTopUpEnabled && (
            <div className="bg-legasi-green/10 border border-legasi-green/30 rounded-lg p-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-legasi-green">🔄 Auto-Top-Up Enabled</span>
              </div>
